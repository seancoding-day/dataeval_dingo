...
1. Dingo is installed: `python3 -c "from dingo.config import InputArgs; print('OK')"`
...
- Missing dingo: `pip install dingo-python` or `pip install -e .` (from project root)
...
```bash
python3 {baseDir}/scripts/fact_check.py $ARGUMENTS
```
