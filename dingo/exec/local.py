...
class LocalExecutor(ExecProto):
    ...
    def evaluate(self):
        ...
        """
        with concurrent.futures.ThreadPoolExecutor(max_workers=self.input_args.thread_num) as thread_executor, \
             concurrent.futures.ProcessPoolExecutor(max_workers=self.input_args.process_num) as process_executor:
