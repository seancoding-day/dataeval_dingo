...
| Rule_TC609_0202_SafetyCompliance | TC609_0202 | Combines unsafe-word, PII, and identity-card detection for text items in `data_content`. | TC609-5-2025-04 High-quality dataset quality evaluation specification |
...
| Rule_TC609_0206_ContentConsistency | TC609_0206 | Checks consistency among text items in `data_content` using multilingual embeddings and robust-center aggregation. | TC609-5-2025-04 High-quality dataset quality evaluation specification |
| Rule_TC609_0207_DataTypeConsistency | TC609_0207 | Checks whether text items in `data_content` match the configured dataset type | TC609-5-2025-04 High-quality dataset quality evaluation specification |
